...
public class UI {
    ...
    private void adaugaStudent() throws ValidationException {
        ...
        System.out.print("Introduceti numele profecorului: ");
        String numeProfesor = scanner.next();
    ...
    private void updateStudent() {
        ...
        String numeProfesor = scanner.next();
        Student student = new Student(id, nume, grupa, email, numeProfesor);
    ...
    private void adaugaNota() throws ValidationException {
        ...
        Long nrTema = scanner.nextLong();
        Long idNota = Long.parseLong(idStudent.toString() + nrTema.toString());
